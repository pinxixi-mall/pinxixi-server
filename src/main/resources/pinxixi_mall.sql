...
DROP TABLE IF EXISTS `pinxixi_mall_admin_user`;

CREATE TABLE `pinxixi_mall_admin_user` (
...
LOCK TABLES `pinxixi_mall_admin_user` WRITE;

INSERT INTO `pinxixi_mall_admin_user` (`user_id`, `user_name`, `password`, `nick_name`, `locked`)
VALUES
	(1,'admin','123','拼夕夕01',0),
